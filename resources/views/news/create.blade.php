...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="" method="post" enctype="multipart/form-data" style="width: 60%; margin-left: 20%;">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="text" rows="8" placeholder="Введите текст..."></textarea>
                </div>
                <div class="form-group">
